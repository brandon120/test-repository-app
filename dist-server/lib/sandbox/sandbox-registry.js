...
export function registerSandbox(taskId, sandbox, _keepAlive = false) {
...
export function unregisterSandbox(taskId) {
    activeSandboxes.delete(taskId);
}
export function getSandbox(taskId) {
    return activeSandboxes.get(taskId);
}
export async function killSandbox(taskId) {
