import { runCommandInSandbox, runInProject } from '../commands.js';
...
export async function executeOpenCodeInSandbox(sandbox, instruction, logger, selectedModel, mcpServers, isResumed, sessionId) {
    try {
        ...
        if (!cliCheck.success) {
            ...
            if (npmBinCheck.success && npmBinCheck.output) {
                ...
                const directPathCheck = await runAndLogCommand(sandbox, `${globalBinPath}/opencode`, ['--version'], logger);
