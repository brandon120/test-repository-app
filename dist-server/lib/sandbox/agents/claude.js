...
export async function installClaudeCLI(sandbox, logger, selectedModel, mcpServers) {
    ...
    let claudeInstall = { success: true };
...
export async function executeClaudeInSandbox(sandbox, instruction, logger, selectedModel, mcpServers, isResumed, sessionId, taskId, agentMessageId) {
